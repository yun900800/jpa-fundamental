...
public abstract class AbstractTest {
    ...
    protected void executeStatement(String sql) {
        try (Connection connection = dataSource().getConnection();
            ...
            LOGGER.error(e, ()->"Statement failed");
        }
    }
    ...
    protected void executeStatement(EntityManager entityManager, String... sqls) {
        ...
        for (String sql : sqls) {
            try {
                ...
                LOGGER.error(
                        e, ()->
                        String.format("Error executing statement: %s", sql)
                );
            }
        }
    }
        ...
        if (cacheRegionStatistics != null) {
            ...
            if (cache != null) {
                ...
                LOGGER.debug(()->String.format("\nRegion: {},\nStatistics: {},\nEntries: {}",
                        regionName,cacheRegionStatistics,cacheEntriesBuilder)
                );
            }
        }
    }
